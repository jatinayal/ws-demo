  ...
  try {
    ...
    await payload.create({
      ...
      data: {
        ...
        areasOfInterest: validAreas as never,
    ...
    return {
      success: true,
      message:
        'Your volunteer application has been submitted successfully. We will be in touch soon!',
    };
  } catch (error) {
  ...
  try {
    await payload.create({
      ...
      data: {
        ...
        email: String(formData.get('email') || ''),
        phone: String(formData.get('phone') || ''),
        partnershipType: String(formData.get('partnershipType') || 'other') as never,
    ...
    return {
      success: true,
      message:
        'Your partnership inquiry has been received. Our team will review your proposal and respond shortly.',
    };
  } catch (error) {
  ...
  try {
    await payload.create({
      ...
      data: {
        ...
        frequency: String(formData.get('frequency') || 'one_time') as never,
        message: String(formData.get('message') || ''),
        status: 'new',
      },
    });
    ...
    return {
      success: true,
      message:
        'Thank you for your pledge! Our team will contact you securely to complete the donation process.',
    };
  } catch (error) {
